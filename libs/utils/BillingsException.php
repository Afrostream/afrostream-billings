...
class ExceptionError extends Enum {
	...
	const COUPON_MAX_REDEMPTIONS_PER_USER_REACHED		=	457;
	const COUPON_ANOTHER_ALREADY_APPLIED				=	458;
	const COUPON_WAITING_STATUS_NOT_FOUND				=	459;
	//
	const REQUEST_UNSUPPORTED							=	600;
}
