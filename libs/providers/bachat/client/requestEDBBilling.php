<?php
	...
	$res = $bachat->requestEDBBilling($request->requestId, $request->gw_idsession, $request->random);

	if ($res->resultMessage == "SUCCESS") {
		$r = "INSERT INTO transactions (type, chargeTransactionId, subscriptionId) VALUES ('BILLING', '$res->chargeTransactionId', '$res->subscriptionId');	";
		$result = db_query($r);
	}
