...
class CeleryUsersHandler extends ProviderUsersHandler {
	...
	public function doCreateUser(CreateUserRequest $createUserRequest) {
		try {
			...
			$msg = "a billings exception occurred while creating a celery user for user_reference_uuid=".$createUserRequest->getUserReferenceUuid().", error_code=".$e->getCode().", error_message=".$e->getMessage();
