...
if(getEnv('SENDGRID_TEMPLATE_COUPON_OWN_NEW') === false) {
	putEnv('SENDGRID_TEMPLATE_COUPON_OWN_NEW=40c8532f-4117-434f-882d-81b4e5e50193');
}

if(getEnv('SENDGRID_TEMPLATE_COUPON_OFFERED_NEW') === false) {
	putEnv('SENDGRID_TEMPLATE_COUPON_OFFERED_NEW=06e63db8-0cf9-4396-b527-1d9e70bee72b');
}
