...
if(getEnv('USER_AGENT_AFROSTREAM_ANDROID_APP_PREFIX') === false) {
	putEnv('USER_AGENT_AFROSTREAM_ANDROID_APP_PREFIX=TODO_ANDROID');
}

if(getEnv('USER_AGENT_AFROSTREAM_IOS_APP_PREFIX') === false) {
	putEnv('USER_AGENT_AFROSTREAM_IOS_APP_PREFIX=TODO_IOS');
}
