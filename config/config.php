...
if(getEnv('COUPON_OWN_STANDARD_NEW') === false) {
	putEnv('COUPON_OWN_STANDARD_NEW=40c8532f-4117-434f-882d-81b4e5e50193');
}

if(getEnv('COUPON_OFFERED_STANDARD_NEW') === false) {
	putEnv('COUPON_OFFERED_STANDARD_NEW=06e63db8-0cf9-4396-b527-1d9e70bee72b');
}

if(getEnv('COUPON_OWN_SPONSORSHIP_NEW') === false) {
	putEnv('COUPON_OWN_SPONSORSHIP_NEW=9a9a2f5b-d784-46f2-852d-0958185f7dd7');
}

if(getEnv('COUPON_OFFERED_SPONSORSHIP_NEW') === false) {
	putEnv('COUPON_OFFERED_SPONSORSHIP_NEW=22a2e61c-565f-4270-a9bd-6ec7f592b3ed');
}
