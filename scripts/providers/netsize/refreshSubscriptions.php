...
require_once __DIR__ . '/../../libs/providers/netsize/BillingsNetsizeWorkers.php';

/*
 * Tool to refresh subscriptions
 */

print_r("starting tool to refresh netsize subscriptions...\n");
...
$providers = ProviderDAO::getProvidersByName('netsize');

foreach ($providers as $provider) {
	$billingsNetsizeWorkers = new BillingsNetsizeWorkers($provider);
